...
description: "Use when automating a new INUT product page from brief to implemented route. Trigger phrases: 'tạo trang sản phẩm mới', 'auto page sản phẩm', 'draft rồi làm route', 'new product landing page'."
---
...
Phải tái sử dụng chuẩn từ:

- `.github/agents/inut-content-writer.agent.md`
- `.github/prompts/write-product-content.prompt.md`
