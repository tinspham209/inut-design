...
Ensure event tracking remains accurate, non-duplicated, and consistent across product and conversion flows.

## Tracking rules

- Use `utils/analytics.ts` as the main event gateway.
