				...
				<Grid container spacing={{ xs: 2, md: 3 }} alignItems="center">
					<Grid item xs={12} md={6}>
						<Stack spacing={{ xs: 1.5, md: 2 }}>
							...
							>
								Thiết kế chỉn chu, in sắc nét và chất liệu cao cấp giúp nâng tầm
								hình ảnh thương hiệu cá nhân và doanh nghiệp tại Đà Nẵng.
							</Typography>
							<Stack
					...
					<Grid item xs={12} md={6}>
						...
						>
							<Image
								src={heroImage}
								alt="In card visit chuyên nghiệp tại Đà Nẵng"
								width={800}
								height={600}
