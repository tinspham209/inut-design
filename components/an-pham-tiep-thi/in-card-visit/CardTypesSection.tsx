...
export const CardTypesSection: React.FC<CardTypesSectionProps> = ({ cardTypes, specOptions }) => {
	return (
		<Grid container spacing={1}>
			<Grid item xs={12}>
				...
				<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" }, mb: 1 }}>
					Tùy theo nhu cầu và phong cách thương hiệu, bạn có thể chọn{" "}
					<strong style={{ color: COLOR_CODE.PRIMARY }}>Card giấy</strong> linh hoạt hoặc{" "}
					<strong style={{ color: COLOR_CODE.PRIMARY }}>Card nhựa</strong> bền bỉ để tối ưu ấn tượng
					đầu tiên.
				</Typography>
			</Grid>
			{cardTypes.map((type) => (
