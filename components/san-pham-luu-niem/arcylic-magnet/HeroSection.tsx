				...
				<Grid container spacing={{ xs: 2, md: 3 }} alignItems="center">
					<Grid item xs={12} md={6}>
						<Stack spacing={{ xs: 1.5, md: 2 }}>
							<Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: { xs: 0.5, md: 0 } }}>
								<Chip label="Acrylic cao cấp 3-5mm" color="primary" size="small" />
							...
							>
								Nam châm mica in hình theo yêu cầu - nhỏ gọn, bền đẹp và nổi bật cho quà tặng,
								merchandise và hoạt động branding doanh nghiệp.
							</Typography>
							<Stack
					...
					<Grid item xs={12} md={6}>
						...
						>
							<Image
								src={heroImage}
								alt="Acrylic Magnet theo yêu cầu"
								width={800}
								height={600}
