	...
	return (
		<Grid container spacing={{ xs: 2, md: 3 }}>
			<Grid item xs={12}>
				...
				>
					Vì sao Acrylic Magnet giúp tăng nhận diện thương hiệu?
				</Typography>
			</Grid>
						...
						>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									>
										Phù hợp cho đơn thử nghiệm, bán lẻ hoặc campaign marketing ngắn hạn.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									<Typography
										...
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Đảm bảo tiến độ cho các lịch sự kiện, quà tặng doanh nghiệp và fanmeeting.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									<Typography fontWeight={600} sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
										Quy trình in UV - cắt CNC - gắn nam châm - QC
									</Typography>
									<Typography
										variant="body2"
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Thành phẩm đồng đều, đường cắt sắc nét và bề mặt hoàn thiện chỉn chu.
									</Typography>
								</Box>
							</Stack>
						</Stack>
			...
			<Grid item xs={12} md={8}>
				<Typography
					...
					sx={{ fontSize: { xs: "1rem", md: "1.25rem" } }}
				>
					Ứng dụng tạo giá trị kinh doanh
				</Typography>
				<Typography
					color="text.secondary"
					sx={{ mb: { xs: 1.5, md: 2 }, fontSize: { xs: "0.875rem", md: "1rem" } }}
				>
					Acrylic Magnet có lợi thế lớn về độ bền và cảm giác cao cấp, phù hợp để làm điểm chạm
					thương hiệu lâu dài trên tủ lạnh, bảng từ và các bề mặt kim loại trong đời sống hằng ngày.
				</Typography>
					...
					>
						...
						<Box sx={{ flex: 1 }}>
							...
							<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
								Chúng tôi cam kết sản phẩm chất lượng cao, giá cạnh tranh và hỗ trợ tận tâm từ khâu
								chuẩn file đến khi giao hàng, giúp bạn triển khai nhanh và đúng mục tiêu kinh doanh.
							</Typography>
						</Box>
					</Stack>
				</Paper>
