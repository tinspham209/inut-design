	...
	return (
		<Grid container spacing={{ xs: 2, md: 3 }}>
			<Grid item xs={12}>
				...
				>
					Vì sao móc khóa mica giúp bạn tăng nhận diện thương hiệu?
				</Typography>
			</Grid>
						...
						>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									>
										Phù hợp cho đơn thử nghiệm mẫu mới hoặc campaign ngắn hạn với ngân sách linh
										hoạt.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									<Typography
										...
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Đáp ứng tốt tiến độ cho quà tặng sự kiện, hàng fanclub và các đợt mở bán theo
										mùa.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									<Typography fontWeight={600} sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
										Quy trình in UV - cắt laser - hoàn thiện phụ kiện
									</Typography>
									<Typography
										variant="body2"
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Đảm bảo đường cắt sắc nét, màu bền và độ hoàn thiện đồng đều trên từng sản phẩm.
									</Typography>
								</Box>
							</Stack>
						</Stack>
			...
			<Grid item xs={12} md={8}>
				...
				>
					Móc khóa mica có lợi thế lớn về cá nhân hóa và tần suất sử dụng hằng ngày. Đây là vật phẩm
					marketing nhỏ gọn nhưng có khả năng tạo nhắc nhớ thương hiệu liên tục với chi phí hợp lý.
				</Typography>
					...
					>
						...
						<Box sx={{ flex: 1 }}>
							...
							<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
								Chúng tôi cam kết sản phẩm chất lượng cao, giá thành cạnh tranh và tư vấn tận tâm từ
								ý tưởng đến thành phẩm. Liên hệ ngay để được hỗ trợ nhanh theo nhu cầu thực tế của
								bạn.
							</Typography>
						</Box>
					</Stack>
