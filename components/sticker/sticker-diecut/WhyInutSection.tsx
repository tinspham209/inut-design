	...
	return (
		<Grid container spacing={{ xs: 2, md: 3 }}>
			<Grid item xs={12}>
				...
				>
					Tại sao Sticker Diecut được ưa chuộng?
				</Typography>
			</Grid>
							...
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									<Typography fontWeight={600} sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
										Số lượng tối thiểu: từ 10 sản phẩm
									</Typography>
									<Typography
										variant="body2"
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Phù hợp cho chiến dịch quảng bá ngắn hạn, quà tặng sự kiện hoặc thử nghiệm mẫu
										mới.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									<Typography
										...
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Đảm bảo tiến độ cho các lịch ra mắt sản phẩm, event và hoạt động truyền thông.
									</Typography>
								</Box>
							</Stack>
							<Stack direction="row" spacing={{ xs: 1, md: 1.5 }} alignItems="flex-start">
								...
								<Box>
									...
									<Typography
										...
										sx={{ fontSize: { xs: "0.8125rem", md: "0.875rem" } }}
									>
										Đường cắt theo cutline chuẩn xác, thành phẩm sắc nét và sẵn sàng bóc dán ngay.
									</Typography>
								</Box>
							</Stack>
						</Stack>
			...
			<Grid item xs={12} md={8}>
				...
				>
					Sticker Diecut phù hợp khi bạn cần tạo điểm nhấn thị giác mạnh: hình dán cắt rời theo đúng
					thiết kế giúp thương hiệu nổi bật hơn, dễ trao tặng, dễ trưng bày và tăng mức độ ghi nhớ.
				</Typography>
					...
					>
						...
						<Box sx={{ flex: 1 }}>
							...
							<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
								...
								nhất. Hãy liên hệ ngay để được tư vấn và nhận mẫu thử miễn phí.
							</Typography>
						</Box>
					</Stack>
				</Paper>
