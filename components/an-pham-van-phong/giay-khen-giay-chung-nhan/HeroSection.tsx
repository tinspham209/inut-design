				...
				<Grid container spacing={{ xs: 2, md: 3 }} alignItems="center">
					<Grid item xs={12} md={6}>
						<Stack spacing={{ xs: 1.5, md: 2 }}>
							<Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: { xs: 0.5, md: 0 } }}>
								...
								<Chip label="Thiết kế trang trọng" color="primary" size="small" />
							</Stack>
							<Typography
								variant="h3"
								fontWeight={800}
							...
							>
								Thiết kế chỉn chu, chất liệu cao cấp và in ấn chuyên nghiệp tại Đà Nẵng giúp nâng tầm hình ảnh của tổ chức, tạo ấn tượng trang trọng cho người nhận.
							</Typography>
							<Stack
					...
					<Grid item xs={12} md={6}>
						...
						>
							<Image
								src={heroImage}
								alt="In giấy khen giấy chứng nhận theo yêu cầu"
								width={800}
								height={600}
