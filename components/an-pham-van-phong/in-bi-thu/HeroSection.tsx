				...
				<Grid container spacing={{ xs: 2, md: 3 }} alignItems="center">
					<Grid item xs={12} md={6}>
						<Stack spacing={{ xs: 1.5, md: 2 }}>
							<Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: { xs: 0.5, md: 0 } }}>
								...
								<Chip label="Bế khuôn & dán mép" color="primary" size="small" />
							</Stack>
							<Typography
								variant="h3"
								fontWeight={800}
							...
							>
								Giải pháp tăng nhận diện thương hiệu doanh nghiệp qua từng lần gửi tài liệu,
								hợp đồng và thư mời tại Đà Nẵng.
							</Typography>
							<Stack
					...
					<Grid item xs={12} md={6}>
						...
						>
							<Image
								src={heroImage}
								alt="In bì thư chuyên nghiệp tại Đà Nẵng"
								width={800}
								height={600}
