...
export default {
	...
	fields: [
		...
		{
			name: "spxSyncNote",
			title: "SPX Sync Note (Automated)",
			type: "text",
			rows: 4,
			description: "Latest sanitized SPX status snapshot managed by automation.",
			readOnly: true,
		},
		{
			...
			type: "string",
			description: "Latest normalized SPX group/subgroup managed by automation.",
			readOnly: true,
		},
		{
		...
		{
			name: "spxSyncError",
			title: "SPX Sync Error (Automated)",
			type: "string",
			description: "Stable operational error code from the latest SPX synchronization.",
			readOnly: true,
