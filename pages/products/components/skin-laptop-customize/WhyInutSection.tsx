	...
	return (
		<Grid container spacing={{ xs: 2, md: 3 }}>
			<Grid item xs={12}>
				...
				>
					INUT Design tiên phong trong công nghệ in decal và cắt tỉa máy in khổ lớn. Sự chú trọng vào chi tiết 
					và chất lượng vượt trội đã giúp hàng ngàn khách hàng tạo ra những mẫu Skin Laptop nổi bật. 
					Chúng tôi hiểu sâu sắc được cấu trúc của mọi loại máy để mang đến sản phẩm ôm sát hoàn hảo.
				</Typography>
			</Grid>
			...
			<Grid item xs={12} md={8}>
				...
				>
					Không chỉ làm mới mà còn là một "Tấm màng giáp" để bảo vệ an toàn cho thiết bị của bạn 
					khỏi mọi tác động xấu trong cuộc sống hàng ngày.
				</Typography>
					...
					>
						...
						<Box sx={{ flex: 1 }}>
							...
							<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
								Nguyên liệu decal được nhập khẩu, cắt theo các máy dập khuôn khổ lớn giúp đường cắt sát lề, ôm khít 
								chuẩn xác đến 99% mọi mẫu máy. In UV bền màu bất chấp nhiệt độ thiết bị. Chúng tôi chịu trách niệm mọi 
								lỗi in ấn, hỗ trợ bạn cho đến khi bạn hài lòng với laptop của mình.
							</Typography>
						</Box>
					</Stack>
				</Paper>
