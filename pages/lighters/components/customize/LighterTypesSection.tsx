...
interface LighterTypesSectionProps {
	lighterTypes: LighterType[];
	coatingOptions: string[];
}

export const LighterTypesSection: React.FC<LighterTypesSectionProps> = ({
	lighterTypes,
	coatingOptions,
}) => {
	return (
		<Grid container spacing={1}>
			<Grid item xs={12}>
				...
				<Typography color="text.secondary" sx={{ fontSize: { xs: "0.875rem", md: "1rem" } }}>
					Chúng tôi cung cấp đầy đủ các dòng bật lửa{" "}
					<strong
						style={{
					...
					chính hãng từ Pháp với nhiều tùy chọn kích thước và lớp phủ
				</Typography>
			</Grid>
