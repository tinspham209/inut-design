...
```
├── /                               # Trang chủ
├── cua-hang/                       # Cửa hàng (redirect to /)
├── lighters/                       # Bật lửa
│   ├── [slug]/                     # Chi tiết bật lửa
│   ├── customize.tsx               # Tùy chỉnh bật lửa
│   └── order-tracking/             # Theo dõi đơn hàng bật lửa
├── products/                       # Sản phẩm chung (Laptop skins, etc.)
│   ├── [slug]/                     # Chi tiết sản phẩm
│   └── skin-laptop-customize.tsx   # Tùy chỉnh skin laptop
├── macnut/                         # Skin nút phím (Macnut)
│   ├── [slug]/                     # Chi tiết skin nút phím
│   └── customize.tsx               # Tùy chỉnh skin nút phím
├── sticker/                        # Stickers
...
├── san-pham-luu-niem/              # Sản phẩm lưu niệm
│   ├── arcylic-magnet/             # Acrylic Magnet
...
├── contact/                        # Liên hệ
├── order-tracking/                 # Theo dõi đơn hàng (General)
├── search/                         # Tìm kiếm
